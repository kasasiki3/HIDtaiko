# HIDtaiko 
##### 低価格で高性能なおうち太鼓プロジェクト
### HIDtaikoでは[筐体](drumhead\readme_drumhead.md)、[接続器](arduino_minimum\arduino_connctor.md)の設計を行っています。
...
## 基盤の制作方法→記事:[zeen](drumhead\readme_drumhead.md) 動画:[youtube](https://www.youtube.com/watch?v=5O0MgKzX0PY)
